...
#define HD_PRMAN_RILEY_PARAM_LIST_SCHEMA_TOKENS \
    (params) \

TF_DECLARE_PUBLIC_TOKENS(HdPrmanRileyParamListSchemaTokens, HDPRMAN_API,
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    HDPRMAN_API
    HdPrmanRileyParamContainerSchema GetParams()
    ...
    /// \class HdPrmanRileyParamListSchema::Builder
    /// 
